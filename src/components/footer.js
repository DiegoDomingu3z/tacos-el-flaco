        ...
        <div className="bg-black text-white py-10">
            <div className="container mx-auto flex flex-col md:flex-row justify-between px-10">
                ...
                <div className="mb-6 md:mb-0">
                    ...
                    <p className="mt-2">
                        <strong>Monday:</strong> 12pm - 9pm
                    </p>
                    <p className="mt-2">
                        <strong>Tuesday:</strong> 12pm - 9pm
                    </p>
                    <p className="mt-2">
                        <strong>Wednesday:</strong> 12pm - 9pm
                    </p>
                    <p className="mt-2">
                        <strong>Thursday:</strong> 12pm - 9pm
                    </p>
                    <p className="mt-2">
                        <strong>Friday:</strong> 12pm - 9pm
                    </p>
                    <p className="mt-2">
                        <strong>Saturday:</strong> 12pm - 9pm
                    </p>
                    <p className="mt-2">
